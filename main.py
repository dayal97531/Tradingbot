main.py# ============================================================
# 🤖 DAYAL'S DEGEN TRADING BOT — Paste this into Google Colab
# ============================================================
...
# STEP 2: Press the ▶️ Play button and your bot will start!
# ============================================================
...
async def do_buy(chat_id, symbol, context):
    ...
    if portfolio.has_position(symbol):
        await context.bot.send_message(chat_id, f"⚠️ Already holding {symbol}")
        return
